...
#### Part 1: Introduction to Activity Classification [[notes](ch3-activity-classification.html)]
We start by explaining how to perform activity classification using a decision tree.

#### Part 2: Evaluating Classifier Performance [[notes](ch3-classifier-performance.html)]
